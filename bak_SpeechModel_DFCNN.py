...
class ModelSpeech(): # 语音模型类
	...
	def CreateModel(self):
		...
		layer_h12 = MaxPooling2D(pool_size=1, strides=None, padding="valid")(layer_h11) # 池化层 100*12
		...
		layer_h15 = MaxPooling2D(pool_size=1, strides=None, padding="valid")(layer_h14) # 池化层 50*6
